        ...
        <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
          <div className="relative flex flex-1 items-center">
            ...
            <Input
              ...
              className="h-10 w-full max-w-md pl-10 bg-gray-50 border-0 focus:ring-2 focus:ring-blue-500"
            />
          </div>
              ...
              <DropdownMenuContent align="end" className="w-80">
                ...
                <div className="max-h-80 overflow-y-auto">
                  <DropdownMenuItem className="flex flex-col items-start p-3">
                    ...
                    <p className="text-xs text-gray-500">Data Structures - Lab 5</p>
                  </DropdownMenuItem>
                  <DropdownMenuItem className="flex flex-col items-start p-3">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-xs text-gray-500">Yesterday</span>
                    </div>
                    <p className="text-sm font-medium">New Class Material</p>
                    <p className="text-xs text-gray-500">Physics - Chapter 5 Notes</p>
                  </DropdownMenuItem>
                </div>
                <DropdownMenuSeparator />
